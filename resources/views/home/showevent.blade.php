...
<body>
  ...
  <header id="header" class="fixed-top" style="background-color: black">
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <a href="/" class="logo me-auto me-lg-0"><img src="/assets/imv/assets/img/logo/logo-imv.png"
  ...
  <div id="event" class="event">
      <div class="banner">
          <div data-bs-toggle="modal" data-bs-target="#eventModal">
              <div class="btn-download" type="button">Download Brosur</div>
          </div>
          <img src="/assets/imv/assets/img/event/banner.png" alt="" class="desktop d-block w-100">
          <img src="/assets/imv/assets/img/event/bannerMo.png" alt="" class="mobile d-block w-100">
      </div>
  </div>
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="event-modal row">
                  ...
                  <div class="col-lg-12 d-flex align-items-stretch order-lg-2">
                    <form action="/guest" method="POST" role="form" class="fdownload form-download">
                      @csrf
                      ...
                      <div class="row">
                        <div class="col-md-6 form-group">
                          ...
                          <input type="text" name="event" class="form-control" id="event" value="{{ $id }}" hidden>
                        </div>
                        <div class="col-md-6 form-group">
                      ...
                      <div class="row">
                        <div class="col-md-6 form-group">
                          <label for="business" class="form-label">Business/Institution Name</label>
                          <input type="text" name="business" class="form-control"id="business" placeholder="Business / Institution Name" required>
                        </div>
                        <div class="col-md-6 form-group">
                          <label for="contact" class="form-label">Contact Number</label>
                          <input type="tel" class="form-control" name="contact" id="contact" placeholder="081xxxxxxxxx" required>
                        </div>
                      </div>
                      <div class="my-3">
                      ...
                      <div class="text-center"><button id="btndownload">Download</button></div>
                    </form>
                    <a href="" class="ld" hidden></a>
                  </div>
                        ...
                        <div class="col-lg-5 mt-5 mt-lg-0 d-flex align-items-stretch">
                            <div class="info">
                                ...
                                <div class="email">
                                    ...
                                    <h4>Email:</h4>
                                    <p><a class="mailto" href="mailto:sales@imv.co.id">sales@imv.co.id</a> <br> <a class="mailto" href="mailto:support@imv.co.id">support@imv.co.id</a> <br> <a class="mailto" href="mailto:cs@imv.co.id">cs@imv.co.id</a>
                                    </p>
                                </div>
                                <div class="phone">
                                ...
                                <div class="whatsapp">
                                    ...
                                    <h4>CS-IMV:</h4>
                                    <p><a href="https://wa.me/6281131128637" target="_blank">+62 811-3112-8637</a>
                                    </p>
                                </div>
  ...
  <script type="text/javascript">
      $(document).ready(function(e) {
          ...
          $("#btndownload").on('click', function(e) {
              e.preventDefault();
              var formDownload = $('form.fdownload').serialize();
              ...
              $.ajax({
                  ...
                  success:function(data){
                    console.log(data);
                      var url = "/storage/file/BROSUR_EVENT_AMD_KAMPUS_INDONESIA_2023.zip" //sementara , harusnya $event->items->filename
                      window.open(url,'_blank');
                      $(".error-message1").hide();
                      $(".sent-message1").text(data.message).show();
                      $('form.fdownload').trigger("reset");
                    ...
                    //   console.log(erKey);
                      ...
                      if(er.business !== undefined && er.business !== null) {
                        html += er.business+" <br> ";
                      }
                      if(er.contact !== undefined && er.contact !== null) {
                        html += er.contact+" <br> ";
                      }
                      $(".error-message1").html(status + " : <br>" + html).show();
                  },beforeSend: function() {
