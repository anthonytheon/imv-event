                    ...
                    <form method="post" action="#" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="event_name" type="text" class="form-control select2bs4 @error('event_name') {{'is-invalid'}} @enderror" id="event_name">
                                    <option value="">--- Select Product ---</option>
                                    <option value=" "> AMD Indonesia Campus Event </option>
                                </select>
                                @error('event_name')
